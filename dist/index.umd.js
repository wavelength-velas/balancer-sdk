    ...
    */
    ...
    class RelayerService {
        ...
        async swapUnwrapExactIn(tokensIn, aaveStaticTokens, amountsIn, rates, funds, slippage, unwrapType, fetchPools = {
            ...
            const calls = this.encodeSwapUnwrap(aaveStaticTokens, exports.SwapType.SwapExactIn, queryResult.swaps, queryResult.assets, funds, limits, unwrapType);
        ...
        async swapUnwrapExactOut(tokensIn, aaveStaticTokens, amountsUnwrapped, rates, funds, slippage, unwrapType, fetchPools = {
            ...
            const calls = this.encodeSwapUnwrap(aaveStaticTokens, exports.SwapType.SwapExactOut, queryResult.swaps, queryResult.assets, funds, limits, unwrapType);
            return {
                function: 'multicall',
                params: calls,
                outputs: {
